package com.latihan.ardab.submissionintermediate.ui.customview
...
class CVPasswordEdit : AppCompatEditText {
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        context.apply {
            setTextColor(ContextCompat.getColor(this, R.color.maroon_4))
            setHintTextColor(ContextCompat.getColor(this, R.color.maroon_4))
